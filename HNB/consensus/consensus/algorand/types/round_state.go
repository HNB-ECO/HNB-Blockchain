...
type RoundState struct {
	Height             uint64 // BlockNum we are working on
	Round              int32
	Step               RoundStepType
	StartTime          time.Time
	...
	CommitRound        int32
	//上一轮的投票信息
	LastCommit       *VoteSet // Last precommits at BlockNum-1
	LastValidators   *ValidatorSet
	TryProposalTimes int32
}

func (rs *RoundState) CopyRoundState() RoundState {
	return *rs
}
